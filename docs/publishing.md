...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/2018-school-test-scores">Loading...</div>
...
1.  Create an LCD that is connected to the Article.
    ...
    * Common values in the LCD to use:
      ...
      * `styles`: `news/projects/all/2018-school-test-scores/styles.bundle.css`
      * `scripts`: `news/projects/all/2018-school-test-scores/app.bundle.js`
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/2018-school-test-scores/",
      "url": "http://static.startribune.com/news/projects-staging/all/2018-school-test-scores/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/2018-school-test-scores/",
      "url": "http://static.startribune.com/news/projects/all/2018-school-test-scores/"
    }
  }
}
```
